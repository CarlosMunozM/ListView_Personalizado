...
public class AdaptadorNoticias  extends ArrayAdapter<Noticias> {
    ...
    public View getView(int position, View convertView, ViewGroup parent)
    {
        ...
        View item = inflater.inflate(R.layout.ly_noticias, null);
        ...
        TextView lblSubtitulo2 = (TextView)item.findViewById(R.id.LblSubTitulo2);
        lblSubtitulo2.setText(getItem(position).getSubtitulo2());
