...
public class WebServices extends AsyncTask<String, Long, String> {
     ...
     */
    public WebServices(String urlWebService, Map<String, String> data, Context activity, Asynchtask callback) {
